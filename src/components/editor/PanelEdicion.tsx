...
export default function PanelEdicion({ template, setTemplate }: PanelEdicionProps) {
  ...
  // Manejo de la lista dinámica del Itinerario
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Selector de Pestañas al estilo de Screen Recording 2026-05-30 at 2.44.14 AM.mov */}
  ...
  {/* NUESTRO NUEVO COMPONENTE CARGADOR INYECTADO */}
  <ImageUploader 
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  className="w-4 h-4 rounded text-purple-600 bg-zinc-950 border-zinc-800 focus:ring-purple-500 accent-purple-500"
                />
              </div>
